...
package dev.teyru.buildlogic.architecture;
...
public final class ArchitectureBoundaryCheckerTest {
    public static void main(String[] args) throws Exception {
        Path root = Files.createTempDirectory("teyru-architecture-");
        expectClean(root);
        ...
        expectSourceFailure(root, "compiler-core", "class Bad { dev.teyru.workspace.Model p; }");
        ...
        expectSourceFailure(root, "language-protocol", "class Bad { dev.teyru.compiler.Driver p; }");
        expectSourceFailure(root, "intellij-plugin", "class Bad { dev.teyru.compiler.Driver p; }");
        expectSourceFailure(root, "gradle-plugin", "class Bad { dev.teyru.resolver.JavaResolver p; }");
