...
class P08WorkspaceIntegrationTest {
  ...
  @Test
  void capturesRealGradleMainTestAndMissingTeyruRootsWithoutTaskWiring() {
    var root =
  ...
  void exportsPortableMultiModuleMainTestEmptyAndMissingRoots() {
    ...
    assertFalse(
        model.modules().getFirst().sourceSets().getFirst().teyruRoots().getFirst().exists());
  ...
  private static WorkspaceExportInput fixture() {
    ...
    var main =
        new SourceSet(
            ...
            List.of(path("app/src/main/teyru", false)),
