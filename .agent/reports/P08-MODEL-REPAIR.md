...
- P08-08: target source-set identity is validated; SOURCE_VISIBILITY SCCs produce `TY-WS-SCC-SOURCE-VISIBILITY`, distinct from build-order cycles.
...
- `./gradlew --no-daemon --dependency-verification=strict :workspace-model:spotlessApply :workspace-model:test --rerun-tasks` — exit 0; 12 tests, 0 failed/skipped. XML: `workspace-model/build/test-results/test/TEST-dev.teyru.workspace.model.P08WorkspaceModelTest.xml`.
