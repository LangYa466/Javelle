...
- `verifyQuick` reached architecture, compiled boundaries, governance and reproducible product archives, then exit 1 at unrelated active `gradle-plugin` Spotless violations (`ExportTeyruWorkspaceModel`, `GenerateTeyruJava`, `GenerateTeyruParameters`, `TeyruPlugin`). No owned LSP file failed.
