...
REVIEW: pending independent rerun by a non-implementer.

RISKS_OR_BLOCKERS: dedicated close/delete and UI task UUID unavailable; neither blocks local implementation because interrupt and canonical agent paths are available.
