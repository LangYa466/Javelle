...
public final class EarlyLowerer {
  public IrSequence lower(
      ...
      org.javelle.compiler.core.syntax.NodeId owner,
      org.javelle.compiler.core.symbol.TypeRef resultType) {
  ...
  private IrNode expression(BoundExpression e) {
    ...
    throw new IllegalArgumentException(
        "JV-DEV-0001 unsupported early lowering expression: " + e.getClass().getSimpleName());
  }

  private SourceOrigin origin(org.javelle.compiler.core.syntax.NodeId n) {
