...
public final class EarlyTypeChecker {
  ...
  private static org.javelle.compiler.core.symbol.TypeRef type(BoundExpression e) {
  ...
  private void unsupported(
      ...
      org.javelle.compiler.core.syntax.NodeId n,
      String f,
      List<Diagnostic> o) {
    o.add(
        new Diagnostic(
            1,
            new DiagnosticCode("JV-DEV-0001"),
            Severity.ERROR,
            u.source(),
            n.rawRange(),
            "unsupported " + f,
  ...
  private Diagnostic diag(
      BoundCompilationUnit u, org.javelle.compiler.core.syntax.NodeId n, String c, String m) {
