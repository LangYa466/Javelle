...
import java.util.*;
import dev.teyru.compiler.core.analysis.SnapshotPublisher;
...
class DiagnosticGenerationBudgetRepairTest {
  private static final SourceId SOURCE = new SourceId("a.teyru", "0".repeat(64));
    ...
    assertThrows(
        ...
        () ->
            DiagnosticJson.read(
                ...
                10_000,
                20,
                Map.of(new SourceId("a.teyru", "1".repeat(64)), 5)));
  }
