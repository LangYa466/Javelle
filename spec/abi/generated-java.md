...
Test obligations: javap/reflection ABI goldens; Java→Javelle and Javelle→Java same-module references; generics/annotations/exceptions/nesting; collision negatives; processor adds-type/fixed-point/duplicate/nontermination cases; deterministic output across clean roots.
