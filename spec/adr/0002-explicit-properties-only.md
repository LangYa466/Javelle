...
Alternatives: global bean projection changes Java name resolution; field auto-property changes encapsulation and ABI. Consequences: cross-JAR property syntax requires versioned Javelle metadata; absent metadata falls back to Java members.
